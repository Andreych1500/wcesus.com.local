<?php
class ApplyCard {
    static function param($int, $get = ''){
        switch($int){
            case 1:
                $param['globPost'] = array(
                    'last_name',
                    'first_name',
                    'middle_name',
                    'is_records_name',
